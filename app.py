...
DATA_URL = (
    r"C:\Users\hriti\OneDrive\Desktop\Streamlit_App\Motor_Vehicle_Collisions_-_Crashes.csv")

st.title("Motor Vehicle Collisions in New York City")
st.markdown(
    "This application is aStreamlit dashboard that can be used to analyze motor vehicle collisions in NYC")
...
st.map(data.query("killed_persons>= @injured_people")
